...
function win(userChoice, pcChoice) {
    ...
    result_p.innerHTML = `Your ${wordConvert(userChoice)} wins over PC's ${wordConvert(pcChoice)}.<br> You Win!`;
...
function lose(userChoice, pcChoice) {
    ...
    userScore_span.innerHTML = userScore;
    pcScore_span.innerHTML = pcScore;
    result_p.innerHTML = `Your ${wordConvert(userChoice)} loses to PC's ${wordConvert(pcChoice)}.<br> You Lose!`; 
...
function draw(userChoice, pcChoice) {
    const userChoice_div = document.getElementById(userChoice);
    result_p.innerHTML = `Your ${wordConvert(userChoice)} equals PC's ${wordConvert(pcChoice)}.<br> It's a draw..`;
